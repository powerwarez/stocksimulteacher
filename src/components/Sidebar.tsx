...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 flex-shrink-0 min-h-screen bg-gray-800 text-white p-4">
      <h1 className="text-3xl font-bold mb-0 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-transparent bg-clip-text">
        학생을
      </h1>
      <h1 className="text-3xl font-bold mb-0 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-transparent bg-clip-text">
        위한
      ...
      <div className="absolute bottom-4 left-4">
        <a
          href="https://onmusil.gyo6.net/apps/board/AN3pZdDJL7I"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            src="https://huggingface.co/spaces/powerwarez/gailabicon/resolve/main/gailab07.png"
            alt="gailab"
            className="w-16 h-16"
          />
        </a>
